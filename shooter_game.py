...
while game:
    if not finish:
        ...
        # statistics
        score_stat = font.Font(None, 30).render("Score: " + str(score), 1, (255, 255, 255))
        lost_stat = font.Font(None, 30).render("Missed: " + str(lost), 1, (255, 255, 255))
        life_stat = font.Font(None, 30).render("Lives: " + str(life), 1, (255, 255, 255))
        ...
        if reload:
            reload_text = font.Font(None, 20).render(
                "Wait!, Reloading!.....",
                1,
                (255, 30, 50)
            )
        ...
        if lost > 5 or life <= 0: # lose
            finish = True
            lost_text = font.Font(None, 60).render("YOU LOSE!", 1, (255, 0, 0))
            window.blit(lost_text, (220, 200))
            mixer.music.stop()
        
        if score >= 10: # win
            finish = True
            lost_text = font.Font(None, 60).render("YOU WIN!", 1, (20, 50, 250))
            window.blit(lost_text, (220, 200))
            mixer.music.stop()
